...
var MenuItem = (function () {
    ...
    Object.defineProperty(MenuItem.prototype, "mnemonic", {
        ...
        get: function () {
            if (this._type === 'command') {
                return commands_1.commands.mnemonic(this._command, this._args);
            }
            if (this._type === 'submenu' && this._menu) {
    ...
    Object.defineProperty(MenuItem.prototype, "icon", {
        ...
        get: function () {
            if (this._type === 'command') {
                return commands_1.commands.icon(this._command, this._args);
            }
            if (this._type === 'submenu' && this._menu) {
...
var Menu = (function (_super) {
     ...
     */
    Menu.prototype.addItem = function (value) {
     ...
     */
    Menu.prototype.insertItem = function (index, value) {
        ...
        var item = Private.asMenuItem(value);
     ...
     */
    Menu.prototype.removeItem = function (value) {
        // Coerce the value to an index.
        var index;
    ...
    Menu.prototype._evtKeyDown = function (event) {
        ...
        var key = keymap_1.keymap.layout.keyForKeydownEvent(event);

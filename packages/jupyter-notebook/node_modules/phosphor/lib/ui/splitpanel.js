...
var SplitLayout = (function (_super) {
    ...
    SplitLayout.prototype.sizes = function () {
        return iteration_1.toArray(iteration_1.map(this._sizers, function (sizer) { return sizer.size; }));
    };
    /**
     * Set the desired sizes for the widgets in the panel.
     *
    ...
    SplitLayout.prototype.setSizes = function (sizes) {
        var n = Math.min(this._sizers.length, sizes.length);
        for (var i = 0; i < n; ++i) {
            var hint = Math.max(0, sizes[i]);

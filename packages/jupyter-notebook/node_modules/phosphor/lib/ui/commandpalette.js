...
var CommandItem = (function () {
    ...
    Object.defineProperty(CommandItem.prototype, "label", {
         ...
         */
        get: function () {
            return commands_1.commands.label(this._command, this._args);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CommandItem.prototype, "caption", {
         ...
         */
        get: function () {
            return commands_1.commands.caption(this._command, this._args);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CommandItem.prototype, "className", {
         ...
         */
        get: function () {
            return commands_1.commands.className(this._command, this._args);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CommandItem.prototype, "isEnabled", {
         ...
         */
        get: function () {
            return commands_1.commands.isEnabled(this._command, this._args);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CommandItem.prototype, "isToggled", {
         ...
         */
        get: function () {
            return commands_1.commands.isToggled(this._command, this._args);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CommandItem.prototype, "isVisible", {
         ...
         */
        get: function () {
            return commands_1.commands.isVisible(this._command, this._args);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CommandItem.prototype, "keyBinding", {
         ...
         */
        get: function () {
            return keymap_1.keymap.findKeyBinding(this._command, this._args);
        },
        enumerable: true,
        configurable: true
    });
...
var CommandPalette = (function (_super) {
     ...
     */
    CommandPalette.prototype.addItem = function (value) {
        // Coerce the value to a command item.
        var item = Private.asCommandItem(value);
     ...
     */
    CommandPalette.prototype.removeItem = function (value) {
        ...
        if (typeof value === 'number') {
            ...
            index = searching_1.indexOf(this._items, value);
        }
    ...
    CommandPalette.prototype.onAfterAttach = function (msg) {
        commands_1.commands.commandChanged.connect(this._onGenericChange, this);
        keymap_1.keymap.bindingChanged.connect(this._onGenericChange, this);
    ...
    CommandPalette.prototype.onBeforeDetach = function (msg) {
        commands_1.commands.commandChanged.disconnect(this._onGenericChange, this);
        keymap_1.keymap.bindingChanged.disconnect(this._onGenericChange, this);
    ...
    CommandPalette.prototype._activate = function (index) {
        ...
        if (newNode) {
            ...
            requestAnimationFrame(function () { query_1.scrollIfNeeded(content, newNode); });
        }
    };
    /**
    ...
    CommandPalette.prototype._triggerActive = function () {
        ...
        if (part.item) {
            input.focus();
            input.select();
            commands_1.commands.execute(part.item.command, part.item.args);
            return;
        }
...
(function (CommandPalette) {
    ...
    var Renderer = (function () {
        ...
        Renderer.prototype.formatShortcut = function (binding) {
            return binding ? binding.keys.map(keymap_1.formatKeystroke).join(' ') : '';
        };
        return Renderer;
    }());
...
(function (Private) {
     ...
     */
    function asCommandItem(value) {
        return value instanceof CommandItem ? value : new CommandItem(value);
    }
    Private.asCommandItem = asCommandItem;
    /**

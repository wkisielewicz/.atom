...
var Widget = (function () {
    ...
    Widget.prototype.focus = function () {
        messaging_1.sendMessage(this, WidgetMessage.FocusRequest);
    };
    /**
    ...
    Widget.prototype.blur = function () {
        messaging_1.sendMessage(this, WidgetMessage.BlurRequest);
    };
    /**
     ...
     */
    Widget.prototype.onFocusRequest = function (msg) {
        if (this.isAttached)
            this.node.focus();
    };
    /**
     ...
     */
    Widget.prototype.onBlurRequest = function (msg) {
        if (this.isAttached)
            this.node.blur();
    };
    /**
...
(function (WidgetMessage) {
     ...
     */
    WidgetMessage.FocusRequest = new messaging_1.ConflatableMessage('focus-request');
    /**
     ...
     */
    WidgetMessage.BlurRequest = new messaging_1.ConflatableMessage('blur-request');
    /**

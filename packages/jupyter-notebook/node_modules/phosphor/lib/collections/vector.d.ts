import { IIterator, IterableOrArrayLike } from '../algorithm/iteration';
import { IMutableSequence } from '../algorithm/sequence';
/**
 * A generic vector data structure.
 */
export declare class Vector<T> implements IMutableSequence<T> {
    /**
